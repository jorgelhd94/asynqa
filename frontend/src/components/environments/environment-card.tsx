      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-1.5 opacity-0 transition-opacity group-hover:opacity-100">
          <Button
            ...
            className="text-(--color-text-muted) hover:bg-(--color-primary-dark) hover:text-(--color-accent-val) focus-visible:ring-(--color-accent-val)"
            onClick={(e) => {
              e.stopPropagation();
              onEdit(env);
            }}
